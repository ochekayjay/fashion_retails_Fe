...
export default function Signup() {
  ...
  return (
    <div style={{backgroundColor:'rgb(228,228,228)',height:'100vh',width:'100vw',display:"flex",alignItems:"center",justifyContent:"center"}}>
        <section style={{height:'80%',width:'85%',display:'flex',backgroundColor:"white",boxShadow:'1px 1px 5px rgb(91, 90, 90)'}}>
            ...
            <div style={{width:'80%',height:"100%",padding:'15px',boxSizing:'border-box'}}>
                <form style={{height:'100%',width:'100%'}}>
                    <section style={{width:'100%',height:'90%',display:"flex"}}>
                        <div style={{height:'100%',width:'33.3%',padding:"15px",display:'flex',flexDirection:"column",justifyContent:"space-around"}}>
